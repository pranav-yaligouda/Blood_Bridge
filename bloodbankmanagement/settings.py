...
TEMPLATE_DIR = os.path.join(BASE_DIR,'templates')#template connection
STATIC_DIR=os.path.join(BASE_DIR,'static')#static files
...
ALLOWED_HOSTS = ['blood-bridge-xcvw.onrender.com', '127.0.0.1', 'localhost']
